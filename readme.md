...
## What is this?
**samuTrain** is a high-level **Training Orchestrator** designed to manage and optimize machine learning workflows. While it currently utilizes **Calamari OCR** as its primary "dummy project," the framework is architected to be engine-agnostic. It provides a structured layer for process management, hardware resource allocation, and dynamic dataset optimization via database-driven logic.
