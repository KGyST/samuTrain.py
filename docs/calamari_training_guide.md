# Calamari Training and Fine-Tuning Guide

## Overview
This guide provides detailed instructions for loading, fine-tuning, and training Calamari OCR models. It covers everything from loading checkpoints to saving trained models.

## Loading a Checkpoint

To load a checkpoint, follow these steps:
...
**Do not use `graph.model.optimizer`** — it may not exist on `CalamariGraph`. Create your own: `optimizer = tf.keras.optimizers.Adam(lr=1e-4)`
