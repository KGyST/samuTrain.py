---
description: Use this rule for managing samuTrain server, database resets, and code style.
alwaysApply: true
---

Tools and rules for managing samuTrain server, database resets, and code style.
